 ...
 * @LastEditTime: 2021-01-25 11:51:14
 * @Describe: 蓝V榜
-->
<template>
    ...
    <div class="talentfind-block tab-block">
       <el-form ref="talentform" :model="talentform">
        ...
        <el-form-item class="cont-set">
              <el-select v-model="talentform.selectTm" placeholder="请选择" size="mini" 
              class="cont-set_select">
              <el-option 
...
<script>
import { gettalentbluevList } from '@/api/locowerApi';
...
export default {
  ...
  methods: {
    ...
    getTalentlt(arr) {
      ...
      this.loading = true;
      gettalentbluevList(params).then((res) => {
        if (res.code === 200) {
